...
\"\n\
checkout_executable TCLSH \"/home/raunak/ns-allinone-2.35/bin/tclsh8.5\" tclsh \"\\\n\
When configured, ns found the right version of tclsh in\\\n\
/home/raunak/ns-allinone-2.35/bin/tclsh8.5\n\
but it doesn't seem to be there anymore, so\\\n\
...
BOLSR  # routing protocol for ad-hoc networks	\n\
AOMDV\n\
\n\
...
\n\
\n\
Agent/BOLSR set debug_       false\n\
Agent/BOLSR set use_mac_     false\n\
Agent/BOLSR set willingness_ 3\n\
Agent/BOLSR set hello_ival_  2\n\
Agent/BOLSR set tc_ival_     5\n\
Agent/BOLSR set mid_ival_    5\n\
...
BOLSR {\n\
set ragent [$self create-bolsr-agent $node]\n\
}\n\
default {\n\
eval $node addr $args\n\
...
\n\
Simulator instproc create-bolsr-agent { node } {\n\
set ragent [new Agent/BOLSR [$node node-addr]]\n\
$self at 0.0 \"$ragent start\"\n\
$node set ragent_ $ragent\n\
return $ragent\n\
}\n\
